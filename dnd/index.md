# ⚔️ D&D Campaign Chronicles

Welcome to the central archive of our tabletop adventures. Select a campaign below to explore session timelines, character dossiers, world lore, and tactical references.
...
- **Session Order:** All logs are chronologically arranged matching our `session-xxx.md` padding convention.
- **Search Engine:** Use the local global search bar on the top-right corner to cross-reference NPCs, items, or spell acquisitions across all four campaigns instantaneously.
